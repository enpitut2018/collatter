...
class TemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create template" do
    assert_difference('Template.count') do
      post templates_url, params: { template: { image: @template.image, tag_txt: @template.tag_txt } }
    end
  ...
  test "should update template" do
    patch template_url(@template), params: { template: { image: @template.image, tag_txt: @template.tag_txt } }
